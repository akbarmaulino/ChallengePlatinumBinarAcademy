...
def wrongEmail = generateRandomEmail()
GlobalVariable.wrong_email = wrongEmail

WebUI.setText(findTestObject('Registration Page/Field_input_Email'), GlobalVariable.wrong_email)
