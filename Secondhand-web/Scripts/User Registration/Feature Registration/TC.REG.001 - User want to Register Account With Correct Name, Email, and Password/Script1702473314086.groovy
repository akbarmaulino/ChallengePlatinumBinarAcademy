...
WebUI.callTestCase(findTestCase('User Registration/Input Email'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verification/Verify Already in Dashboard'), [:], FailureHandling.STOP_ON_FAILURE)
