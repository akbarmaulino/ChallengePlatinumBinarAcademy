...
WebUI.callTestCase(findTestCase('User Registration/Input Email Already Registered'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verification/Verify Email Already Registered'), [:], FailureHandling.STOP_ON_FAILURE)
