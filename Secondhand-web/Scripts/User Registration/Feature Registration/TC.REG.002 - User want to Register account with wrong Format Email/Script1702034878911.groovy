...
WebUI.callTestCase(findTestCase('User Registration/Input Email Wrong Format'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Verification/Verify Email Wrong Format'), [:], FailureHandling.STOP_ON_FAILURE)
