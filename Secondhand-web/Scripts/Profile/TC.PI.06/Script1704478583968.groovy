...
WebUI.sendKeys(findTestObject('profile/Page_SecondHand/input_Nama'), 'Mawar')

WebUI.selectOptionByIndex(findTestObject('profile/Page_SecondHand/select_kota'), '4')

WebUI.sendKeys(findTestObject('profile/Page_SecondHand/input_alamat'), 'Jl. Kenangan')

WebUI.sendKeys(findTestObject('profile/Page_SecondHand/input_No_Handphone'), 'awawwkwkk')
