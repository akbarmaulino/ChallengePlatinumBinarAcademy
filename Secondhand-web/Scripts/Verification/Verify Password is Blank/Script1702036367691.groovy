...
def field_blank_password = driver.findElement(By.id('user_password'))


def message = WebUI.executeJavaScript('return arguments[0].validationMessage', Arrays.asList(field_blank_password))
