...
def field_blank_name = driver.findElement(By.id('user_name'))


def message = WebUI.executeJavaScript('return arguments[0].validationMessage', Arrays.asList(field_blank_name))
