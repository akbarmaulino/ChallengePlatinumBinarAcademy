...
def field_wrong_format_email = driver.findElement(By.id('user_email'))



def message = WebUI.executeJavaScript('return arguments[0].validationMessage', Arrays.asList(field_wrong_format_email))

def  myField = findTestObject('Registration Page/Field_input_Email')
def isiField = WebUI.getAttribute(myField, 'value')
