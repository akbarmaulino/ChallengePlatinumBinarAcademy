...
Mobile.callTestCase(findTestCase('User Registration/Input Email Wrong Format'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Verification/Verify Email is Wrong Format'), [:], FailureHandling.STOP_ON_FAILURE)
