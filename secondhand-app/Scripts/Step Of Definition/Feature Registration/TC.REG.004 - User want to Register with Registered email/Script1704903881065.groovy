...
Mobile.callTestCase(findTestCase('User Registration/Input Registed Email'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.callTestCase(findTestCase('Verification/Verify Email Ready Registed'), [:], FailureHandling.STOP_ON_FAILURE)
